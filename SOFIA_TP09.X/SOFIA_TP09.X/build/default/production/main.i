...
__eeprom RegistroCliente listaclientes[10];
...
void exibirLista(){
    for(int i = 0; i < 21; i++){
        if(listaclientes[i].estado == 2){
            ...
            EUSART_Write(0x0D);
        } else if(listaclientes[i].estado == 1) {
            EUSART_Write(0x20);
            EUSART_Write(0x20);
            for(int j = 0; j < 20 && listaclientes[i].Nome[j] != 0; j++){
            EUSART_Write(listaclientes[i].Nome[j]);
...
void armazenarNome(){
    ...
    if(buffer_nome[0] == 0){
        ...
        listaclientes[countNome].estado = 0;
    }
    else {
        nome_nulo = 0;
        ...
        listaclientes[countNome].estado = 1;
    }
}
