...
# 723 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\\pic\\include\\proc\\pic16f887.inc" 1 3
# 47 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\\pic\\include\\proc\\pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2818 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\\pic\\include\\proc\\pic16f887.inc" 3
...
# 724 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\\pic\\include\\pic_as_chip_select.inc" 2 3
...
;--- CONFIGURAÇÃO DAS PORTAS ---
 ...
 ;--- CONFIGURANDO PORTAS COMO ENTRADAS E SAÍDAS ---
    ...
    ;Configura ((PORTE) and 07Fh), 0 como entrada para seleção de algoritmo
    BANKSEL TRISE
    bsf TRISE, 0 ; Configura ((PORTE) and 07Fh), 0 como entrada
...
escolhe_metodo:
    BANKSEL PORTE
    movf PORTE,W ; Lê o estado do pino ((PORTE) and 07Fh), 0
    btfsc PORTE, 0 ; Verifica se o pino ((PORTE) and 07Fh), 0 = 1
    call divisao_deslocamento ; Se o pino ((PORTE) and 07Fh), 0 for 1 (HIGH), vai para divisao por deslocamento
    call divisao_sub_sucessivas ; Se o pino ((PORTE) and 07Fh), 0 for 0(LOW), vai para divisao por subtração sucessivas
...
; --- TRATAMENTO PARA DENOMINADOR ((STATUS) and 07Fh), 2 ---
zero_case: ; Quando Q=0 o valor do resto = Numerador. Ligando o LED ((PORTE) and 07Fh), 1
