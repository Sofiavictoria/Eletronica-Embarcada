...
FINAL_IMAGE=${DISTDIR}/TP02SOFIA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=TP02SOFIA.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/TP02SOFIA.o
POSSIBLE_DEPFILES=${OBJECTDIR}/TP02SOFIA.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/TP02SOFIA.o

# Source Files
SOURCEFILES=TP02SOFIA.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TP02SOFIA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/TP02SOFIA.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/TP02SOFIA.o: TP02SOFIA.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TP02SOFIA.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/TP02SOFIA.o \
	TP02SOFIA.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/TP02SOFIA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/TP02SOFIA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
